...
namespace Microsoft.BotBuilderSamples
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var blobStorageConnectionString = Configuration.GetSection("BlobStorageConnectionString")?.Value;
            var blobStorageContainerName = Configuration.GetSection("BlobStorageContainerName")?.Value;
